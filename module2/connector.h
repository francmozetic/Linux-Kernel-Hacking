...
void __cn_del_callback(struct cb_id *);
int __cn_netlink_send_mult(struct cn_msg *msg, u16 len, u32 portid, u32 group, gfp_t gfp_mask);
int __cn_netlink_send(struct cn_msg *msg, u32 portid, u32 group, gfp_t gfp_mask);
